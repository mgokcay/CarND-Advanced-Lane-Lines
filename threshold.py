...
def threshold(img, s_thresh=(170, 255), sx_thresh=(40, 255)):
    ...
    # l_channel_threshold[(l_channel_threshold < 200)] = 0
    #
    # s_channel_threshold = np.copy(s_channel)
    # s_channel_threshold[(s_channel_threshold < 240)] = 0
    #
    # u_channel_threshold = np.copy(u_channel)
    # u_channel_threshold[(u_channel_threshold < 150)] = 0
    #
    ...
    #
    # ax6.imshow(u_channel_threshold)
